    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form class=" row mb-30" action="{{ route('articles.update') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="repeater">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <label for="Name"
                                                ...
                                                :</label>
                                            <textarea  class="form-control" type="text"  name="description">value="{{$article->description}}</textarea>
                                        </div>
