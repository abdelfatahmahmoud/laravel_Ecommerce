                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-md-6">All Articles</div>
                                    <div class="col-md-6">
                                        <div class="col-md-6">
                                            <a href="{{route('articles.create')}}" class="btn btn-success float-end">add new articles</a>
                                        </div>                          </div>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                    @php
                                        $i=($articles->currentPage()-1)*$articles->perPage();
                                    @endphp
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <!-- edit_form -->
                                                        <form action="{{ route('articles.update', 'test') }}" method="post">
                                                            {{ method_field('patch') }}
                                                            @csrf
                                                            <div class="row">
                                                                <div class="col">
