...
{{--                                        </div>--}}
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="product-action-1 show">
                                            <a aria-label="Add To Cart" class="action-btn hover-up" href="#" wire:click="store({{$fproduct->id}},'{{$fproduct->name}}',{{$fproduct->regular_price}})"><i class="fi-rs-shopping-bag-add"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                      ...
                      @foreach($populars as $popular)
                        <div class="card-1">
                            <figure class=" img-hover-scale overflow-hidden">
                                <a href="{{route('product.category',['slug'=>$popular->slug])}}"><img src="{{asset("assets/imgs/category")}}/{{$popular->image}}" alt="{{$popular->name}}"></a>
                            </figure>
                            <h5><a href="{{route('product.category',['slug'=>$popular->slug])}}">{{$popular->name}}</a></h5>
                        </div>
                        @endforeach
