                            ...
                            <div class="card-body">
                                ...
                                <form wire:submit.prevent="updateProduct">
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input name="regular_price" type="text" class="form-control" placeholder="enter category regular_price" wire:model="regular_price">
                                        @error('regular_price')
                                        <p class="text-danger">{{$message}}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3 mt-3">
                                        <label for="category_id" class="form-lable">featured </label>
